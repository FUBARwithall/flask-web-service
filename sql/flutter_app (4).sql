...
--
-- Host: localhost:3306
-- Generation Time: Jan 18, 2026 at 05:52 AM
...
--
-- Table structure for table `body_analyses`
--
...
--
-- Dumping data for table `body_analyses`
--

INSERT INTO `body_analyses` (`id`, `user_id`, `timestamp`, `image_filename`, `image_url`, `disease_key`, `disease_name`, `confidence`, `all_predictions`, `note`) VALUES
('06dbe688-70c3-40b2-9875-98c8711fa3e1', 8, '2026-01-15 13:30:43.596970', '06dbe688-70c3-40b2-9875-98c8711fa3e1.jpg', '/static/uploads/body_analyses/06dbe688-70c3-40b2-9875-98c8711fa3e1.jpg', 'kudis', 'Kudis', 94.62, '{\"eksim\": 5.38, \"kudis\": 94.62, \"kurap\": 0.0, \"impetigo\": 0.0, \"vitiligo\": 0.0, \"psoriasis\": 0.0, \"varicella\": 0.0}', NULL),
('3bd0e05d-b017-4948-9d16-346088c57639', 8, '2026-01-15 13:07:45.411931', '3bd0e05d-b017-4948-9d16-346088c57639.jpg', '/static/uploads/body_analyses/3bd0e05d-b017-4948-9d16-346088c57639.jpg', 'kudis', 'Kudis', 60.68, '{\"eksim\": 0.09, \"kudis\": 60.68, \"kurap\": 38.11, \"impetigo\": 0.49, \"vitiligo\": 0.05, \"psoriasis\": 0.2, \"varicella\": 0.39}', NULL),
('63b7b3d6-006f-482d-a92c-51237e325d1c', 5, '2026-01-18 10:59:26.807686', '63b7b3d6-006f-482d-a92c-51237e325d1c.jpg', '/uploads/body_analyses/63b7b3d6-006f-482d-a92c-51237e325d1c.jpg', 'kudis', 'Kudis', 94.62, '{\"eksim\": 5.38, \"kudis\": 94.62, \"kurap\": 0.0, \"impetigo\": 0.0, \"vitiligo\": 0.0, \"psoriasis\": 0.0, \"varicella\": 0.0}', 'uy'),
('cc0b06a0-1ee6-4530-883a-a6f919098b6e', 5, '2026-01-18 11:21:54.431478', 'cc0b06a0-1ee6-4530-883a-a6f919098b6e.jpg', '/uploads/body_analyses/cc0b06a0-1ee6-4530-883a-a6f919098b6e.jpg', 'kudis', 'Kudis', 94.62, '{\"eksim\": 5.38, \"kudis\": 94.62, \"kurap\": 0.0, \"impetigo\": 0.0, \"vitiligo\": 0.0, \"psoriasis\": 0.0, \"varicella\": 0.0}', 'pp');

-- --------------------------------------------------------

--
-- Table structure for table `daily_drink_logs`
--
...
--
-- Dumping data for table `daily_drink_logs`
--
...
--
-- Dumping data for table `daily_food_logs`
--
...
--
-- Table structure for table `daily_skin_analysis`
--
...
--
-- Dumping data for table `daily_skin_analysis`
--
...
(6, 5, '2026-01-18', 4, 1, 0, 0, 0, 10, 1, 4, 'AMAN', 'Serat kurang', '2026-01-18 04:07:09');

-- --------------------------------------------------------

--
-- Table structure for table `daily_sleep_logs`
--
...
--
-- Dumping data for table `daily_sleep_logs`
--
...
--
-- Table structure for table `face_analyses`
--
...
--
-- Dumping data for table `face_analyses`
--

INSERT INTO `face_analyses` (`id`, `user_id`, `timestamp`, `image_filename`, `image_url`, `skin_type`, `skin_type_confidence`, `skin_type_predictions`, `skin_problem`, `skin_problem_confidence`, `skin_problem_predictions`, `note`) VALUES
('56d19790-934e-49a0-a63f-f687e55ec02e', 5, '2026-01-17 21:45:05.236739', '56d19790-934e-49a0-a63f-f687e55ec02e.jpg', '/uploads/analyses/56d19790-934e-49a0-a63f-f687e55ec02e.jpg', 'Berminyak', 99.97, '{\"Kering\": 0.03, \"Normal\": 0.0, \"Berminyak\": 99.97}', 'Berjerawat', 56.08, '{\"Normal\": 4.37, \"Berjerawat\": 56.08, \"Dermatitis Perioral atau Ruam\": 39.55}', 'cihuy'),
('79ef9334-f9bb-4088-b949-15fbc75a021b', 8, '2026-01-15 12:13:04.310890', '79ef9334-f9bb-4088-b949-15fbc75a021b.jpg', '/static/uploads/analyses/79ef9334-f9bb-4088-b949-15fbc75a021b.jpg', 'Normal', 99.94, '{\"Kering\": 0.06, \"Normal\": 99.94, \"Berminyak\": 0.0}', 'Normal', 76, '{\"Normal\": 76.0, \"Berjerawat\": 0.0, \"Dermatitis Perioral atau Ruam\": 24.0}', 'ini akbar'),
('8e9b87c1-0a80-4bd2-bab1-acbd19dd37fd', 9, '2026-01-15T01:43:32.969557Z', '8e9b87c1-0a80-4bd2-bab1-acbd19dd37fd.jpg', '/static/uploads/analyses/8e9b87c1-0a80-4bd2-bab1-acbd19dd37fd.jpg', 'Normal', 100, '{\"Kering\": 0.0, \"Normal\": 100.0, \"Berminyak\": 0.0}', 'Normal', 86.42, '{\"Normal\": 86.42, \"Berjerawat\": 0.0, \"Dermatitis Perioral atau Ruam\": 13.58}', NULL),
('ac97f42b-3a40-4a62-822d-f19e5332a422', 5, '2026-01-18 11:08:53.319661', 'ac97f42b-3a40-4a62-822d-f19e5332a422.jpg', '/uploads/analyses/ac97f42b-3a40-4a62-822d-f19e5332a422.jpg', 'Normal', 61.93, '{\"Kering\": 38.07, \"Normal\": 61.93, \"Berminyak\": 0.0}', 'Normal', 95.18, '{\"Normal\": 95.18, \"Berjerawat\": 0.0, \"Dermatitis Perioral atau Ruam\": 4.82}', 'oooo'),
('b25bd717-35d1-49a6-a9b4-1133bada436f', 5, '2026-01-15 13:56:45.885623', 'b25bd717-35d1-49a6-a9b4-1133bada436f.jpg', '/static/uploads/analyses/b25bd717-35d1-49a6-a9b4-1133bada436f.jpg', 'Normal', 99.89, '{\"Kering\": 0.11, \"Normal\": 99.89, \"Berminyak\": 0.0}', 'Normal', 99.95, '{\"Normal\": 99.95, \"Berjerawat\": 0.0, \"Dermatitis Perioral atau Ruam\": 0.05}', NULL),
('d0f520ba-d5df-4cba-91e4-690d3c37e5a1', 9, '2026-01-15T01:45:32.271184Z', 'd0f520ba-d5df-4cba-91e4-690d3c37e5a1.jpg', '/static/uploads/analyses/d0f520ba-d5df-4cba-91e4-690d3c37e5a1.jpg', 'Kering', 89.3, '{\"Kering\": 89.3, \"Normal\": 10.7, \"Berminyak\": 0.0}', 'Normal', 67.29, '{\"Normal\": 67.29, \"Berjerawat\": 1.48, \"Dermatitis Perioral atau Ruam\": 31.23}', NULL);
...
--
-- Table structure for table `glowmate`
--
...
--
-- Dumping data for table `glowmate`
--

INSERT INTO `glowmate` (`id`, `user_id`, `type`, `hour`, `minute`, `is_active`, `created_at`, `updated_at`) VALUES
(1, 5, 'morning', 6, 14, 1, '2026-01-12 01:47:04', '2026-01-18 05:40:50'),
(2, 9, 'afternoon', 14, 53, 1, '2026-01-14 07:52:16', '2026-01-14 07:52:25'),
(3, 5, 'afternoon', 12, 46, 1, '2026-01-18 04:55:29', '2026-01-18 05:45:32');
...
(10, 'some thing', 'smthing10101@gmail.com', 'scrypt:32768:8:1$7NGM0zPcQijzm78z$067337e9f9924edca87abc328f52981ed715225bb9752035cc1cb6d6e82d675bed301e99806f26a3dbeb2dbf4cfb112e2191ad6c47236fa7a80ce4d62514c840', 0, '2026-01-18 04:51:49');
...
--
-- Indexes for table `body_analyses`
--
...
--
-- Indexes for table `daily_drink_logs`
--
...
--
-- Indexes for table `daily_skin_analysis`
--
...
--
-- Indexes for table `daily_sleep_logs`
--
...
--
-- Indexes for table `face_analyses`
--
...
--
-- AUTO_INCREMENT for table `daily_drink_logs`
--
ALTER TABLE `daily_drink_logs`
  MODIFY `id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
...
--
-- AUTO_INCREMENT for table `daily_skin_analysis`
--
ALTER TABLE `daily_skin_analysis`
  MODIFY `id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;

--
-- AUTO_INCREMENT for table `daily_sleep_logs`
--
ALTER TABLE `daily_sleep_logs`
  MODIFY `id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;

--
-- AUTO_INCREMENT for table `glowmate`
--
ALTER TABLE `glowmate`
